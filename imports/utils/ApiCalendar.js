/*
Forked from: https://github.com/Insomniiak/react-google-calendar-api/blob/master/ApiCalendar.js
*/
    ...
    initClient() {
      ...
      Meteor.call('getGoogleKeys', function(err, res) {
        const Config = {
          ...
          parentThis.gapi = window['gapi'];
          parentThis.gapi.client.init(Config)
          .then(() => {
            // Listen for sign-in state changes.
            parentThis.gapi.auth2.getAuthInstance().isSignedIn.listen(parentThis.updateSigninStatus);
            // Handle the initial sign-in state.
            parentThis.updateSigninStatus(parentThis.gapi.auth2.getAuthInstance().isSignedIn.get());
            if (parentThis.onLoadCallback) {
              parentThis.onLoadCallback();
            }
          })
          .catch((e) => {
            console.log(e);
